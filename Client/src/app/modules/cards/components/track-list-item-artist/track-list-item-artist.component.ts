...
@Component({
  selector: 'app-track-list-item-artist',
  templateUrl: './track-list-item-artist.component.html',
  styleUrls: ['./track-list-item-artist.component.scss']
})
export class TrackListItemArtistComponent {
